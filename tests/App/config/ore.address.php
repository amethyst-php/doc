...
return [
    ...
    */
    ...
    |
    */
    'entity' => Railken\LaraOre\Tests\App\Address\Address::class,
    ...
    |
    */
    'manager' => Railken\LaraOre\Tests\App\Address\AddressManager::class,
    ...
    |
    */
    'repository' => Railken\LaraOre\Tests\App\Address\AddressRepository::class,
    ...
    |
    */
    'serializer' => Railken\LaraOre\Tests\App\Address\AddressSerializer::class,
    ...
    |
    */
    'validator' => Railken\LaraOre\Tests\App\Address\AddressValidator::class,
    ...
    |
    */
    'authorizer' => Railken\LaraOre\Tests\App\Address\AddressAuthorizer::class,
    ...
    */
    'http' => [
        'admin' => [
            'enabled'    => true,
            'controller' => Railken\LaraOre\Tests\App\Http\Controllers\Admin\AddressesController::class,
            'router'     => [
                'prefix'      => '/addresses',
            ],
        ],
