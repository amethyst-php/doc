...
namespace Railken\LaraOre\Tests\App\Address\Attributes\ZipCode;

use Railken\LaraOre\Tests\App\Address\Attributes\ZipCode\Exceptions as Exceptions;
...
class ZipCodeAttribute extends BaseAttribute
{
     ...
     * Is a value valid ?
     *
     * @param \Railken\LaraOre\Tests\App\Address\Address $entity
     * @param mixed                                      $value
     *
     * @return bool
     */
